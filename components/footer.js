  ...
  return `
    <footer class="site-footer">
      <div class="container footer-inner reveal reveal-delay-1">
        ...
        <div class="footer-legal"><p>© 2026 ${siteConfig.name}</p><p>${siteConfig.responsible} — CNPJ ${siteConfig.cnpj}</p><p>${siteConfig.address}</p><p><a href="mailto:${siteConfig.email}">${siteConfig.email}</a> · <a href="${siteConfig.whatsappUrl}" target="_blank" rel="noopener noreferrer">${siteConfig.whatsapp}</a></p></div>
