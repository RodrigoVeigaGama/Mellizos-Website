...
src/
  config/site.js                Dados da empresa (nome, e-mail, WhatsApp, CNPJ...) — fonte única
...
- **Contato, nome, CNPJ ou endereço:** edite só `src/config/site.js`. Nos arquivos HTML esses dados
