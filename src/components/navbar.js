import { quoteMessage, whatsappUrl } from '../config/site.js';

const whatsappIcon = '<svg aria-hidden="true" viewBox="0 0 24 24"><path d="M20.5 3.5A11.8 11.8 0 0 0 12.1 0C5.6 0 .3 5.3.3 11.8c0 2.1.6 4.1 1.6 5.8L.2 24l6.6-1.7a11.8 11.8 0 0 0 5.3 1.3h.1c6.5 0 11.8-5.3 11.8-11.8 0-3.1-1.3-6.1-3.5-8.3Z"/></svg>';
...
export function renderNavbar() {
  return `
      ...
      <div class="container header-inner">
        ...
        <nav class="main-nav" aria-label="Navegação principal">
          ...
          <div class="nav-actions">
            ...
            <a class="button button-small button-whatsapp" href="${whatsappUrl(quoteMessage)}" target="_blank" rel="noopener noreferrer">
              ${whatsappIcon}
    ...
    <div class="nav-notice">Atendemos somente via orçamento para que possamos adequar cada projeto à sua realidade. Está em dúvida? Envie-nos uma mensagem. O que você tem a perder?</div>`;
}
